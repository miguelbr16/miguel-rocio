...
export const caso002Days: Caso002Day[] = [
  ...
  },
  {
    ...
    icon: "🎵",
    tipo: "BANDA SONORA",
    txt: "Agente Ro. Banda sonora del Caso 002.\n\nCada capítulo necesita música. Envíale a M la canción que más os represente **desde que se cerró el Caso 001**.",
    mode: "reto",
    reto: "Mándasela. Confirmación de M → 3 toques en el sello.",
    unlock: "Guardada en el expediente. Nuestra. Sonará en la cápsula.",
    evidence: {
      stamp: "PRUEBA 04",
      ...
      lines: [
        ...
        "Uso previsto: montaje cápsula 18 nov",
